...
const myObj ={'item1':{'name':'Button1','color':'#FF3D00'},'item2':{'name':'Button2','color':'#3D00FF'},'item3':{'name':'Button3','color':'#FFFF3D'},'item4':{'name':'Button4','color':'#FF3DFF'},'item5':{'name':'Button5','color':'#3DFF00'},'item6':{'name':'Button6','color':'#3D00FF'},'item7':{'name':'Button7','color':'#FF3DFF'},'item8':{'name':'Button8','color':'#3DFF00'}};
